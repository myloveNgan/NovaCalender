<?php
   ...
   $departmentsList = DepartmentsController::DepartmentsList()
?>

@php
    $currentPath = $_SERVER['REQUEST_URI'];

    $showClass = (strpos($currentPath, 'employees') !== false) ? 'show' : '';
    $showAccount = (strpos($currentPath, 'account') !== false || strpos($currentPath, 'createacount') !== false) ? 'show active' : '';
        ...
        <div class="navigationbar">
            <div class="vertical-menu-icon">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    {{-- nó có 1 class active --}}
                   <a href="{{ route('EmployeesByDept_ID', ['id' => 1]) }}">
                    <a class="nav-link" id="v-pills-crm-tab" data-toggle="pill" href="#v-pills-crm" role="tab" aria-controls="v-pills-crm" aria-selected="true"><img src="{{ asset('backend/assets/images/svg-icon/crm.svg') }}" class="img-fluid" alt="Nhân sự" data-toggle="tooltip" data-placement="top" title="Nhân sự"></a>
                   </a>
                    <a class="nav-link" id="v-pills-ecommerce-tab" data-toggle="pill" href="#v-pills-ecommerce" role="tab" aria-controls="v-pills-ecommerce" aria-selected="false"><img src="{{ asset('backend/assets/images/svg-icon/ecommerce.svg') }}" class="img-fluid" alt="eCommerce" data-toggle="tooltip" data-placement="top" title="Phòng Ban"></a>                            
                    <a class="nav-link" id="v-pills-hospital-tab" data-toggle="pill" href="#v-pills-hospital" role="tab" aria-controls="v-pills-hospital" aria-selected="false"><img src="{{ asset('backend/assets/images/svg-icon/ecommerce.svg') }}" class="img-fluid" alt="Hospital" data-toggle="tooltip" data-placement="top" title="Hospital"></a>
                    <a class="nav-link" id="v-pills-uikits-tab" data-toggle="pill" href="#v-pills-uikits" role="tab" aria-controls="v-pills-uikits" aria-selected="false"><img src="{{ asset('backend/assets/images/svg-icon/ecommerce.svg') }}" class="img-fluid" alt="UI Kits" data-toggle="tooltip" data-placement="top" title="UI Kits"></a>
                    <a class="nav-link" id="v-pills-pages-tab" data-toggle="pill" href="#v-pills-pages" role="tab" aria-controls="v-pills-pages" aria-selected="false"><img src="{{ asset('backend/assets/images/svg-icon/authentication.svg') }}" class="img-fluid" alt="Pages" data-toggle="tooltip" data-placement="top" title="Tài khoản"></a>
                </div>
            </div>
            <div class="vertical-menu-detail">
                <div class="logobar">
                    <a href="index.html" class="logo logo-large"><img src="{{ asset('backend/assets/images/nova-logo.png') }}" class="img-fluid" alt="logo"></a>
                </div>
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade {{ $showClass }}" id="v-pills-crm" role="tabpanel" aria-labelledby="v-pills-crm-tab">
                        <ul class="vertical-menu">
                            <li><h5 class="menu-title">Nhân sự</h5></li>
                            <li>
                                <a href="javaScript:void();">
                                  <img src="{{ asset('backend/assets/images/svg-icon/basic_page.svg') }}" class="img-fluid" alt="basic_page"><span>Phòng ban</span><i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                     @foreach ($departmentsList as $item)
                                     <li><a href="{{ route('EmployeesByDept_ID', ['id' => $item->dept_id]) }}">{{ $item->name }}</a></li>
                                     @endforeach
                                </ul>
                            </li> 
                            <li>
                    ...
                    <div class="tab-pane fade" id="v-pills-ecommerce" role="tabpanel" aria-labelledby="v-pills-ecommerce-tab">
                        <ul class="vertical-menu">
                            ...
                            <li><a href="dashboard-ecommerce.html"><img src="{{ asset('backend/assets/images/svg-icon/dashboard.svg') }}" class="img-fluid" alt="dashboard">Dashboard</a></li>
                            <li>
                                <a href="javaScript:void();">
                    ...
                    <div class="tab-pane fade" id="v-pills-hospital" role="tabpanel" aria-labelledby="v-pills-hospital-tab">
                        <ul class="vertical-menu">
                            ...
                            <li><a href="dashboard-hospital.html"><img src="{{ asset('backend/assets/images/svg-icon/dashboard.svg') }}" class="img-fluid" alt="dashboard">Dashboard</a></li>
                            <li><a href="hospital-appointment.html"><img src="{{ asset('backend/assets/images/svg-icon/calender.svg') }}" class="img-fluid" alt="appointments">Appointments</a></li>
                            <li><a href="hospital-doctor.html"><img src="{{ asset('backend/assets/images/svg-icon/doctor.svg') }}" class="img-fluid" alt="doctors">Doctors</a></li>
                            <li><a href="hospital-patient.html"><img src="{{ asset('backend/assets/images/svg-icon/customers.svg') }}" class="img-fluid" alt="patients">Patients</a></li>                                    
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane fade {{ $showAccount }}" id="v-pills-pages" role="tabpanel" aria-labelledby="v-pills-pages-tab">
                        <ul class="vertical-menu">
                            <li><h5 class="menu-title">Tài khoản</h5></li>
                            <li>
                                <a href="javaScript:void();">
                                  <img src="{{ asset('backend/assets/images/svg-icon/basic_page.svg') }}" class="img-fluid" alt="basic_page"><span>Phòng ban</span><i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    @foreach ($departmentsList as $item)
                                    <li><a href="{{ route('AccountByDept_ID',['id'=>$item->dept_id , 'message'=>'mess']) }}">{{ $item->name }}</a></li>
                                    @endforeach    
                                </ul>
                            </li> 
                            <li class="d-none">
