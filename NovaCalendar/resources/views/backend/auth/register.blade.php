...
<!-- Mirrored from themesbox.in/admin-templates/soyuz/html/light-vertical/user-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Nov 2023 11:40:17 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="auth-box-right">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 mt-3">Already have an account? <a href="user-login.html">Log in</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Auth Box -->
